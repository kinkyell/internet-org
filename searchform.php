...
<form class="searchBox searchBox_inPanel js-searchView js-searchFormView" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label for="mainMenu-search" class="searchBox-icon searchBox-icon_lrg js-searchView-trigger">
		...
		<span class="u-isVisuallyHidden"><?php echo esc_attr_x( 'Search', 'label' ) ?></span>
	</label>
	<input type="search" id="mainMenu-search" class="searchBox-input searchBox-input_tall js-searchView-input" name="s" placeholder="" value="<?php echo get_search_query() ?>">
</form>
