		...
		if ( supportedBrowser ) {
			...
			$( document ).on( 'click', settings.feedbackButton, function() {
				...
				if ( ! isExtensionPrompted && ( RBExtension.detected === false ) && rbExtensionURL !== '' ) {		//if extension is not installed (browser is chrome, firefox or safari) and we've not prompted to install it yet, let's do it now
					...
					$( 'body' ).append( '<div id="feedback-module" class="rb-install-extension-dialog"><div id="feedback-submit-error" class="feedback-install-extension"><p>Your screenshots will be inaccurate if you don\'t install our browser extension. Please click below to install it.</p><a href="' + rbExtensionURL + '" target="_blank" class="feedback-close-btn feedback-btn-blue rb-install-extension">Yes, install the Rollerblade Extension</a><a href="#" target="_blank" class="feedback-close-btn feedback-btn-blue rb-dont-install-extension">No, keep using bad screenshots</a><div class="feedback-box-top"><p></p></div><div class="feedback-wizard-close"></div></div></div>' );
