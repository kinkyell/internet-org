 ...
 *
 * Search form in the mobile is different than the serachform.php version, use this one for mobile.
 *
...
<form class="searchBox searchBox_inPanel searchBox_inPanelMobile js-searchFormView" role="search">
	...
	<input type="search" id="mainMenu-search" class="searchBox-input searchBox-input_inPanelMobile js-searchView-input" name="s" placeholder="<?php echo esc_attr_x( 'Search', 'placeholder', 'internetorg' ) ?>" value="<?php echo esc_attr( get_search_query() ); ?>">
</form>
