		...
		<div class="footer-left">
			<div class="topicBlock">
				<div class="topicBlock-hd">
					...
					data-social="true"
					data-type="titled" <?php if ( $display_story_Next == "full_screen") { if ( is_array($showImageNext) && $showImageNext[0]!="") { ?> data-image-display="<?php echo esc_attr( $showImageNext[0] ); ?>" <?php } ?> <?php if ( is_array($showMediaNext) && $showMediaNext[0]!="") { ?> data-video="<?php echo esc_attr( $showMediaNext[0] ); ?>" <?php } } ?>  data-story-page="<?php echo esc_attr( $display_story_Next ); ?>" <?php if ( is_array($header_color_Next) && $header_color_Next[0]!="") { ?> data-header-color="<?php echo esc_attr( $header_color_Next[0] ); ?>" <?php } ?> <?php if ( is_array($header_img_color_Next) && $header_img_color_Next[0]!="") { ?> data-header-img-color="<?php echo esc_attr( $header_img_color_Next[0] ); ?>" <?php } ?>  data-page="single">
				...
				<div class="topicBlock">
					<div class="topicBlock-hd">
						<a class="<?php echo esc_attr( internetorg_english_lang_notification_class( ['or' => 'js-stateLink'], $prev_post->ID ) ); ?>"
							...
							data-type="titled" <?php if ( $display_story_Prev == "full_screen") { if ( is_array($showImagePrev) && $showImagePrev[0]!="") { ?> data-image-display="<?php echo esc_attr( $showImagePrev[0] ); ?>" <?php } ?> <?php if ( is_array($showMediaPrev) && $showMediaPrev[0]!="") { ?> data-video="<?php echo esc_attr( $showMediaPrev[0] ); ?>" <?php } } ?>  data-story-page="<?php echo esc_attr( $display_story_Prev ); ?>" <?php if ( is_array($header_color_Prev) && $header_color_Prev[0]!="") { ?> data-header-color="<?php echo esc_attr( $header_color_Prev[0] ); ?>" <?php } ?> <?php if ( is_array($header_img_color_Prev) && $header_img_color_Prev[0]!="") { ?> data-header-img-color="<?php echo esc_attr( $header_img_color_Prev[0] ); ?>" <?php } ?>  data-page="single">
