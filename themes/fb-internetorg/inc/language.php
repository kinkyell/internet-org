...
if ( ! function_exists( 'internetorg_language_switcher' ) ) :
	...
	function internetorg_language_switcher() {
		...
		echo '<select id="js-LanguageView" class="js-select" onchange="document.location.href=document.location.pathname.replace(/\/(.*?)\//, this.options[this.selectedIndex].value);">';
