...
<?php while ( have_posts() ) : the_post(); ?>
	...
	<div class="viewWindow isShifted js-viewWindow js-stateDefault" id="main-content" role="main" data-route="<?php echo esc_url( fix_link( get_the_permalink() ) ); ?>" data-type="panel" data-theme="<?php echo esc_attr( fix_link( internetorg_get_page_theme() ) ); ?>" data-title="<?php the_title(); ?>" data-image="<?php echo esc_url( internetorg_get_post_thumbnail( get_the_ID(), 'panel-image' ) ); ?>" data-mobile-image="<?php echo esc_url( internetorg_get_post_thumbnail( get_the_ID(), 'inline-image' ) ); ?>">
