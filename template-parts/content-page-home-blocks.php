						...
						<div class="narrative-section-bd-inner">
							...
							<?php endif; ?>
								...
								<div class="transformBlock-bd">
									...
									<?php if ( ! empty( $fieldset['call-to-action'] ) ) : ?>
										...
										<?php foreach ( $fieldset['call-to-action'] as $cta ) : ?>
											...
											<?php if ( ! empty( $cta['link'] ) ) : ?>
												<a href="<?php echo esc_url( internetorg_fix_link( apply_filters( 'iorg_url', $cta['link'] ) ) ); ?>"><?php
												if ( ! empty( $cta['image'] ) ) : ?>
									...
									<a href="<?php echo esc_url( internetorg_fix_link( $sectionHref ) ); ?>" class="link link_theme<?php echo esc_attr( $sectionSlug ); ?> js-stateLink"><?php echo esc_html( $fieldset['name'] ); ?></a>
								</div>
							</div>
						</div>
					</div>
