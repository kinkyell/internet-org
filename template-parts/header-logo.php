...
<a class="header-logo js-headerView-logo js-stateHome" href="<?php echo esc_url( home_url() ); ?>">
	<span class="u-isVisuallyHidden"><?php echo esc_html( get_bloginfo( 'name' ) ); ?></span>
