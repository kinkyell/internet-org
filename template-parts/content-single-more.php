		...
		<div>
			<div class="topicBlock">
				<div class="topicBlock-hd">
					<a class="js-stateLink" href="<?php echo esc_url( fix_link( get_permalink( $next_post->ID ) ) ); ?>"
				...
				<div class="topicBlock-cta">
					<a class="btn js-stateLink" href="<?php echo esc_url( fix_link( get_permalink( $next_post->ID ) ) ); ?>"
					   data-title="<?php echo esc_attr( apply_filters( 'the_title',  $next_post->post_title ) ); ?>"
					   data-date="<?php echo esc_attr( get_the_date( '', $next_post->ID ) ); ?>"
					   data-social="true"
					   data-type="titled">
		...
		<div>
			<div class="topicBlock">
				<div class="topicBlock-hd">
				  ...
				  href="<?php echo esc_url( fix_link( get_permalink( $prev_post->ID ) ) ); ?>"
